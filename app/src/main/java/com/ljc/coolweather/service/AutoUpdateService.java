package com.ljc.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent i =new Intent(this,AutoUpdateService.class);     //在这个服务执行时，又再次定时启动这个服务
                                                                //并且这个服务只创建一次
        PendingIntent pi = PendingIntent.getService(this,0,i,0);       //这个pi执行后，会调用服务的onstart方法
        manager.cancel(pi);     //取消之前的定时
